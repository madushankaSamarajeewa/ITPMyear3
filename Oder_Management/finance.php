	...
	//if ($orders) 
	{
		...
		while ($order = mysqli_fetch_assoc($orders)) {
			...
			$order_list .="<tr>";
				...
				$order_list .="<td><a href=\"modify-finance.php?finance_id={$order['id']}\">Edit</a></td>";
				$order_list .="<td><a href=\"delete-finance.php?finance_id={$order['id']}\">delete</a></td>";
...
<body>
	...
	<main>
		...
		<h1>Order<span><a href="add-finance.php">Add New Order</a> | <a href="finance.php">Refresh</a></span></h1>
		<div class="search">
