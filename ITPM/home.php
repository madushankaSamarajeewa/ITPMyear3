            ...
            <div class="col-full">
               <div id="primary" class="content-area">
                  <main id="main" class="site-main" >
                     ...
                     <div class="stretch-full-width section-products-sale-event"  style="background-size: cover; background-position: center center; background-image: url( assets/images/piza/5.jpg ); height: 468px;">
         ...
         <footer id="colophon" class="site-footer footer-v1" >
            <div class="col-full">
               ...
               <div class="site-address">
                  <ul class="address">
                     <li>Hungry Hub</li>
                     <li>Telephone: +94 71 789 1535</li>
                     <li>Fax: +94 11 555 4444</li>
                  </ul>
               </div>
               <div class="site-info">
                  <p class="copyright">Copyright &copy; 2022 Hungry hub. All rights reserved.</p>
               </div>
